...
(defun setup-tide-mode ()
  ...
  ;; install it separately via package-ins
tall
...
* Load other files
   #+BEGIN_SRC emacs-lisp
     ...
     (load-if-exists "~/shared/mu4econfig.el")
     (load-if-exists "~/shared/not-for-github.el")
...
(define-key z-map (kbd "*") 'calc)
  ...
  (global-set-key (kbd "\e\ei")
                  (lambda () (interactive) (find-file "~/orgfiles/i.org")))
...
#+BEGIN_SRC 
;;(set-face-attribute 'region nil :background "#2352350" :foreground "#ffffff")
